 ...
 <div class="container">
  <div class="row">
   ...
   <!--Side Product start-->
    ...
    <div class="item">
      <img alt="" title="" src="productimg/img10.jpg" class="iw">    </div>
    <div class="item">
      <img alt="" title="" src="productimg/img10.jpg" class="iw">    </div>
    <div class="item">
      <img alt="" title="" src="productimg/img10.jpg" class="iw">    </div>
    ...
    <li class="" data-slide-to="0" data-target="#article-photo-carousel">
      <img alt="" src="productimg/img10.jpg">    </li>
    ...
    <li class="active" data-slide-to="3" data-target="#article-photo-carousel">
	  ...
	  <div class="col-sm-7 space_left">
	   <div class="center_shop_1ri clearfix">
	     <h2 class="mgt">CPCE2624A High-Current Power Inductor</h2>
		 <h6>
	   <span>
	   ...
	   <p>CPCE2624A series high-current power inductor features magnetic powder core technology, which provides stable inductance value and saturation over high operating temperatures.</p>
				  ...
				  <div id="home_description" class="tab-pane fade clearfix active in">
					 <div class="click clearfix">
					   <div class="click_inner clearfix">
						...
						<p>The soft saturation characteristics can withstand high peak current. Flat wire winding is designed to deliver stable inductance and saturation at high temperatures up to +150°C, and the low DCR reduces power losses and increases efficiency. The CPCE2624A series through-hole design offers excellent vibration resistance. Customization for this series is also available, and the inductors are RoHS/REACH compliant and halogen-free.</p>
					   </div>
					   <div class="click_inner clearfix">
					    <h4>Features</h4>
						<ul>
                        <li>Magnetic powder core</li>
                        <li>High inductance and high current</li>
                        <li>High saturation and high performance</li>
                        <li>Operating temperature: -55°C ～ +150°C</li>
                        <li>Hot-dipped tin plating reduces the risk of whisker growth</li>
                        <li>Customized options available</li>
						</ul>
					   </div>
					   <div class="click_inner clearfix">
					    <h4>Applications </h4>
                        ...
                        <li>Photovoltaic industry, solar energy, and wind energy</li>
                        <li>Battery testing equipment</li>
                        <li>Aging test equipment</li>
