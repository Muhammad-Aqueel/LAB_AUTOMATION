var table_room =  $('.table_room').DataTable({
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="LMS/assets/mycustom/js/logo.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;"></h4>\
							<br><h5>Aptech Learning</h5>\
	...
	"ajax":
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="."  style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;"></h4>\
				<br><h5>Aptech Learning</h5>\
							<h6>Karachi, Pakistan</h6>\
							</center>',
				customize: function ( win ) {
