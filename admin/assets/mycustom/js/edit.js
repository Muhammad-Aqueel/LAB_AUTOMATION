     ...
     var append = '  <form class="frm_edititem">\
						...
						<div class="form-group">\
							...
							<select name="e_category" class="form-control" required>\
								...
								<option>Low Power Inductor</option>\
								<option>Sensor</option>\
								<option>Coprocessors</option>\
								<option>JFETs</option>\
								<option>High Power Inductor</option>\
								<option>Infrared Array Sensors</option>\
								<option>Fuses</option>\
								<option>Transistor</option>\
								<option>Resistive Sensor</option>\
    ...
    var append = '  <form class="frm_echangeitem">\
                        ...
                        <div class="form-group">\
                            ...
                            <select name="change_status" class="form-control" required="required">\
                             	<option value="2">Company Fail Product</option>\
                             	<option value="3">CPRI Pass Product</option>\
                            	<option value="4">CPRI Fail Product</option>\
                            </select>\
