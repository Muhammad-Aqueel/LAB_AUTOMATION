				...
				<div class="row">
					<div class="col-md-12">
						<ul class="nav nav-pills">
							<li class="active"><a href="#new" data-toggle="tab"><i class=""></i>&nbsp;&nbsp;Company Pass Products</a></li>
							<li><a href="#old" data-toggle="tab"><i class=""></i>&nbsp;&nbsp;Company Fail Products</a></li>
							<li><a href="#lost" data-toggle="tab"><i class=""></i>&nbsp;&nbsp;CPRI Pass Products</a></li>
							<li><a href="#damaged" data-toggle="tab"><i class=""></i>&nbsp;&nbsp;CPRI Fail Products</a></li>
								...
								<table class="table table_inventory_all">
									<thead>
										<tr>
											<th>Category</th>
											<th>New</th>
											<th>(Co.Fail / CPRI P. / CPRI F. / Borrowed / Transferred)</th>
											<th>Total</th>
										</tr>
									</thead>
								</table>
