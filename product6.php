 ...
 <div class="container">
  <div class="row">
   ...
   <!--Side Product start-->
    ...
    <div class="item">
      <img alt="" title="" src="productimg/img13.jpg" class="iw">    </div>
    <div class="item">
      <img alt="" title="" src="productimg/img13.jpg" class="iw">    </div>
    <div class="item">
      <img alt="" title="" src="productimg/img13.jpg" class="iw">    </div>
    ...
    <li class="" data-slide-to="0" data-target="#article-photo-carousel">
      <img alt="" src="productimg/img13.jpg">    </li>
    ...
    <li class="active" data-slide-to="3" data-target="#article-photo-carousel">
	  ...
	  <div class="col-sm-7 space_left">
	   <div class="center_shop_1ri clearfix">
	     <h2 class="mgt">Grid-EYE® Wide-Angle Infrared Array Sensors</h2>
		 <h6>
	   <span>
	   ...
	   <p>AMG88x543 Grid-EYE wide-angle infrared array sensors feature high-resolution 8 pixels by 8 pixels for a total of 64 pixels for temperature distribution. These 90° sensors offer a digital output I²C external interface for thermal presence, direction, and temperature values. The built-in lens includes an improved 90° viewing angle and features a compact SMD design using MEMS thermopile technology. They are available in 3.3 V and 5.0 V operating voltage options.</p>
	   <h4 class="col_1 normal"><span>Rs:9999</span> Rs:8999</h4>
	   <h5>Quantity:</h5>
				  ...
				  <div id="home_description" class="tab-pane fade clearfix active in">
					 <div class="click clearfix">
					   <div class="click_inner clearfix">
						...
						<p>The Grid-EYE wide-angle type sensor applications include human detection, people counting, thermal mapping, digital signage, security, lighting control, kiosks/ATMs, medical imaging, automatic doors, robotics, and more.</p>
					   </div>
					   <div class="click_inner clearfix">
					    <h4>Features</h4>
						<ul>
                        <li>Improved viewing from 60° to 90° for larger area coverage</li>
                        <li>Compatible with previous AMG88xx 60° model</li>
                        <li>High-resolution 8 pixels x 8 pixels for a total of 64 pixels for temperature distribution</li>
                        <li>PCB mountable device, SMD type</li>
                        <li>Applied voltage: 3.3 V ±0.3 V or 5.0 V ±0.5 V</li>
						</ul>
					   </div>
					   <div class="click_inner clearfix">
					    <h4>Applications </h4>
						<ul>
                        <li>HVACs and air conditioners/building energy management systems (BEMS)</li>
                        <li>Microwave ovens/kitchen appliances</li>
                        <li>Surveillance/security systems</li>
                        <li>Automatic doors/elevators</li>                            
						</ul>
					   </div>
					   <div class="click_inner clearfix">
						<blockquote>
