 ...
 <div class="container">
  <div class="row">
   ...
   <!--Side Product start-->
    ...
    <div class="item">
      <img alt="" title="" src="productimg/img8.jpg" class="iw">    </div>
    <div class="item">
      <img alt="" title="" src="productimg/img8.jpg" class="iw">    </div>
    <div class="item">
      <img alt="" title="" src="productimg/img8.jpg" class="iw">    </div>
    ...
    <li class="" data-slide-to="0" data-target="#article-photo-carousel">
      <img alt="" src="productimg/img8.jpg">    </li>
    ...
    <li class="active" data-slide-to="3" data-target="#article-photo-carousel">
	  ...
	  <div class="col-sm-7 space_left">
	   <div class="center_shop_1ri clearfix">
	     <h2 class="mgt">MAX66250/MAX66301 NFC Secure Authenticators and Coprocessors</h2>
		 <h6>
	   <span>
	   ...
	   <p>MAX66250 and MAX66301 NFC secure authenticators and coprocessors provide a complete contactless security solution. These products feature the latest SHA-3 challenge-and-response cryptographic algorithm coupled with NFC ISO 15693 interface to authenticate and protect against security attacks and prevent counterfeits.</p>
	   <h4 class="col_1 normal"><span>Rs:999</span> Rs:499</h4>
	   <h5>Quantity:</h5>
				  ...
				  <div id="home_description" class="tab-pane fade clearfix active in">
					 <div class="click clearfix">
					   <div class="click_inner clearfix">
						...
						<p>The MAX66301-25x evaluation system (MAX66301-25XEVKIT#) comprises a MAX66301 evaluation kit (EV kit) and a MAX66250 tag. The MAX66301 EV kit combines an RFID reader for contactless communication at 13.56 MHz and a SHA-3 secure authenticator coprocessor. The RFID reader covers the ISO 15693 standard, and the authenticator coprocessor is based on the FIPS202-compliant standard. The MAX66250 tag operates as a solution covering the ISO 15693 standard and combines FIPS202-compliant secure hash algorithm (SHA-3) challenge and response authentication with secured EEPROM. By pairing the MAX66301 with the MAX66250 into an EV system, the EV kit software can operate to show a secure challenge and response authentication and other part-specific functionality.</p>
					   </div>
					   <div class="click_inner clearfix">
					    <h4>Features</h4>
						<ul>
						 <li>SHA-3 challenge-and-response algorithm provides a crypto-strong security solution for robust</li>
						 <li>ISO 15693 interface supports greater communication distance for passive NFC tags.</li>
						 <li>256-bit secure EEPROM with non-resettable decrement-only counter.</li>
						</ul>
					   </div>
					   <div class="click_inner clearfix">
					    <h4>Applications </h4>
						<ul>
						 <li>NFC-enabled embedded systems. </li>
					   ...
					   <div class="click_inner clearfix">
						<blockquote>
						 <p class="mgt">the authenticator coprocessor is based on the FIPS202-compliant standard. The MAX66250 tag operates as a solution covering the ISO 15693 standard and combines FIPS202-compliant secure hash algorithm (SHA-3) challenge and response authentication with secured EEPROM. By pairing the MAX66301 with the MAX66250 into an EV system, the EV kit software can operate to show a secure challenge and response authentication and other part-specific functional.</p>
						</blockquote>
					   </div>
				    </div>
				  </div>
