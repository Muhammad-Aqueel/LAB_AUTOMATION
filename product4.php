 ...
 <div class="container">
  <div class="row">
   ...
   <!--Side Product start-->
    ...
    <div class="item">
      <img alt="" title="" src="productimg/img9.jpg" class="iw">    </div>
    <div class="item">
      <img alt="" title="" src="productimg/img9.jpg" class="iw">    </div>
    <div class="item">
      <img alt="" title="" src="productimg/img9.jpg" class="iw">    </div>
    ...
    <li class="" data-slide-to="0" data-target="#article-photo-carousel">
      <img alt="" src="productimg/img9.jpg">    </li>
    ...
    <li class="active" data-slide-to="3" data-target="#article-photo-carousel">
	  ...
	  <div class="col-sm-7 space_left">
	   <div class="center_shop_1ri clearfix">
	     <h2 class="mgt">LSK389 Series Dual N-Channel JFETs</h2>
		 <h6>
	   <span>
	   ...
	   <p>LSK389 series is an ultra-low-noise dual junction field effect transistor (JFET) with models including LSK389A, LSK389B, LSK389C, and LSK389D. The models are graded by IDSS. The LSK389B grade model is designed for ultra-high-end systems, ranging from U.S. Navy underwater listening to studio reference amps and microphones..</p>
	   <h4 class="col_1 normal"><span>Rs:2999</span> Rs:1999</h4>
	   <h5>Quantity:</h5>
				  ...
				  <div id="home_description" class="tab-pane fade clearfix active in">
					 <div class="click clearfix">
					   <div class="click_inner clearfix">
						...
						<p>These JFETs are individually tested for noise to ensure datasheet compliance. The two halves of the dual are interwoven using a proprietary design for optimal matching characteristics.</p>
					   </div>
					   <div class="click_inner clearfix">
					    <h4>Features</h4>
						<ul>
                          <li>  Monolithic dual N-channel JFET</li>
                          <li>Tight matching and high CMRR</li>
                            <li>Ultra-low-noise: en = 1.3 nV/√Hz at 1 kHz (typ.)</li>
                            <li>SOIC 8L RoHS</li>
                            <li>Tight offset voltage and low drift over the temperature specifications</li>
						</ul>
					   </div>
					   <div class="click_inner clearfix">
					    <h4>Applications </h4>
						<ul>
                        <li>Ultra-high-end audio</li>
                        <li>Military sensors</li>
                        <li>Audio amps and preamps</li>
                        <li>Discrete low-noise operational amps</li>
                        <li>Battery-operated audio preamps</li>
                        <li>Audio mixer consoles</li>
                        <li>Acoustic sensors</li>
						</ul>
					   </div>
					   <div class="click_inner clearfix">
						<blockquote>
						 <p class="mgt">LSK389B, LSK389C, and LSK389D. The models are graded by IDSS. The LSK389B grade model is designed for ultra-high-end systems, ranging from U.S. Navy underwater listening to studio reference amps and microphones.</p>
						</blockquote>
					   </div>
				    </div>
				  </div>
